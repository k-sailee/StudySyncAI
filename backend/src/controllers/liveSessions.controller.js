...
export const getStudentSessions = async (req, res) => {
  try {
    ...
    // Prefer per-user connection refs to avoid composite index requirements
    try {
      ...
      console.warn("Unable to read per-user connection refs, falling back", err.message || err);
    }

    // Fallback to main connections collection when needed
    if (!teacherIds.size) {
