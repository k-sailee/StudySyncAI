...
export const createScheduledClass = async (req, res) => {
  ...
  try {
    ...
    console.log("[BACKEND] Creating class with data:", {
  subject,
  date,
  time,
  students,
  teacherEmail,
    ...
    if (!subject || !date || !time || !teacherEmail) {
    ...
    // ✅ ALSO SAVE PER-STUDENT (FOR FAST STUDENT FETCH)
...
export const getTeacherClasses = async (req, res) => {
  ...
  console.log("[BACKEND] Fetching classes for teacher:", teacherEmail);
  ...
  console.log("[BACKEND] Teacher classes fetched:", classes.length);
  res.json(classes);
};

export const getStudentClasses = async (req, res) => {
  const { studentId } = req.query;
  console.log("[BACKEND] Fetching classes for student:", studentId);
  ...
  console.log("[BACKEND] Student classes fetched:", classes.length);
