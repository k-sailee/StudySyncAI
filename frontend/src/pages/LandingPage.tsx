...
<section
  id="about"
  className="w-full max-w-6xl mx-auto mt-24 mb-24 px-4 scroll-mt-28"
>
  <h2
  ...
  <p
    className="max-w-3xl mx-auto text-lg text-center mb-16"
    style={{ color: palette.textSecondary }}
  >
    StudySync is an intelligent study planning platform that connects students
    and teachers through smart scheduling, real-time collaboration, and
  ...
  <div className="grid md:grid-cols-2 gap-8 mb-16">
    ...
    >
      ...
      <p className="text-white/90">
        Plan your studies, manage assignments, track progress, and get instant
        doubt resolution. Stay motivated with smart reminders and analytics.
      </p>
    </div>
    ...
    >
      ...
      <p className="text-white/90">
        Assign tasks, monitor student performance, conduct live lessons, and
        guide students using real-time insights and analytics.
      </p>
    </div>
  </div>
  ...
  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
    <div
      ...
      style={{ background: palette.card, boxShadow: palette.shadowLight }}
    >
      <h4 className="font-bold text-lg mb-2" style={{ color: palette.text }}>
        AI-Powered Planning
      </h4>
      <p style={{ color: palette.textSecondary }}>
        Smart schedules and task recommendations tailored to your learning style.
      </p>
    </div>
    ...
    >
      ...
      <p style={{ color: palette.textSecondary }}>
        Interactive live classes, group studies, and real-time discussions.
      </p>
    </div>
    ...
    >
      ...
      <p style={{ color: palette.textSecondary }}>
        Visual dashboards to track growth, consistency, and performance.
      </p>
    </div>
  </div>
</section>
